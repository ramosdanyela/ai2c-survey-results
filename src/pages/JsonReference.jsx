...
export default function JsonReference() {
  ...
  // Usa dados reais do surveyData.json (agora dinâmico via hook)
      ...
      attributesSection.subsections.forEach((subsection) => {
        if (subsection.data) {
          if (subsection.id === "attributes-department") {
            data.department = subsection.data;
          } else if (subsection.id === "attributes-tenure") {
            data.tenure = subsection.data;
          } else if (subsection.id === "attributes-role") {
            data.role = subsection.data;
          }
        }
      });
    }
  ...
  // Funções para extrair dados reais do JSON - AGORA DINÂMICAS (recalculam quando surveyDataJson muda)
  ...
  const renderComponentExampleWithData = (componentType, exampleConfig = {}, customData = null) => {
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-start gap-3 p-3 bg-muted/30 rounded-lg">
                      ...
                      <div className="flex-1">
                        ...
                        <ul className="text-sm text-muted-foreground mt-2 space-y-1 ml-4 list-disc">
                          ...
                          <li><code>components</code>: Array de componentes (opcional, usado quando não há subsections)</li>
                          <li><code>questions</code>: Array de questões (apenas na seção "responses")</li>
                          <li><code>data</code>: Dados específicos da seção (opcional)</li>
                        </ul>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3 p-3 bg-muted/30 rounded-lg">
                      ...
                      <div className="flex-1">
                        ...
                        <ul className="text-sm text-muted-foreground mt-2 space-y-1 ml-4 list-disc">
                          ...
                          <li><code>data</code>: Dados específicos da subseção (opcional)</li>
                        </ul>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3 p-3 bg-muted/30 rounded-lg">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-muted-foreground">
                          Objeto contendo os dados específicos usados pelos componentes através do <code>dataPath</code>
                        </p>
                        <ul className="text-sm text-muted-foreground mt-2 space-y-1 ml-4 list-disc">
                          <li><code>data</code>: Disponível em seções e subseções (opcional)</li>
                          <li>Estrutura varia conforme a seção e os componentes que a utilizam</li>
                          <li>Componentes acessam os dados através do campo <code>dataPath</code> (ex: <code>"sectionData.barChart"</code>)</li>
                          <li>Para seção "attributes": contém dados por atributo (ex: <code>department</code>, <code>tenure</code>, <code>role</code>)</li>
                          <li>Para seção "responses": contém <code>config</code> com configurações de categorias NPS</li>
                          <li>Outras seções: contêm dados específicos (ex: <code>distribution</code>, <code>recommendationsTable</code>, etc.)</li>
                          <li><strong>Nota:</strong> O campo <code>questions</code> está no nível da seção "responses", não dentro de <code>data</code></li>
                        </ul>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3 p-3 bg-muted/30 rounded-lg">
                      <Badge variant="outline" className="mt-1">questions</Badge>
                      <div className="flex-1">
                        <p className="font-medium">Questões (apenas seção "responses")</p>
                        <p className="text-sm text-muted-foreground">
                          Array de questões disponível apenas na seção "responses"
                        </p>
                        <ul className="text-sm text-muted-foreground mt-2 space-y-1 ml-4 list-disc">
                          <li><code>id</code>: Identificador único da questão (number)</li>
                          <li><code>index</code>: Ordem de exibição (number)</li>
                          <li><code>questionType</code>: Tipo da questão ("nps", "multiple-choice", "single-choice", "open-ended")</li>
                          <li><code>question</code>: Texto da questão (string)</li>
                          <li><code>summary</code>: Resumo/análise da questão (string)</li>
                          <li><code>data</code>: Dados específicos da questão (object)</li>
                        </ul>
                        <p className="text-xs text-muted-foreground mt-2 italic">
                          Nota: Os componentes são gerados automaticamente baseados no questionType, não há campo "components" nas questões.
                        </p>
                      </div>
                    </div>

                    <div className="flex items-start gap-3 p-3 bg-muted/30 rounded-lg">
                      <Badge variant="outline" className="mt-1">uiTexts</Badge>
                      <div className="flex-1">
                        ...
                        <ul className="text-sm text-muted-foreground mt-2 space-y-1 ml-4 list-disc">
                          <li><code>filterPanel</code>: Textos do painel de filtros (object)</li>
                          <li><code>export</code>: Textos relacionados à exportação (object)</li>
                          <li><code>common</code>: Textos comuns (loading, errors, etc.) (object)</li>
                        </ul>
                      </div>
                    </div>

                    <div className="flex items-start gap-3 p-3 bg-muted/30 rounded-lg">
                      <Badge variant="outline" className="mt-1">surveyInfo</Badge>
                      <div className="flex-1">
                        ...
                        <ul className="text-sm text-muted-foreground mt-2 space-y-1 ml-4 list-disc">
                          <li><code>title</code>: Título da pesquisa (string)</li>
                          <li><code>company</code>: Nome da empresa (string)</li>
                          <li><code>period</code>: Período da pesquisa (string)</li>
                          <li><code>totalRespondents</code>: Total de respondentes (number)</li>
                          <li><code>responseRate</code>: Taxa de resposta (number)</li>
                          <li><code>questions</code>: Número total de questões (number)</li>
                        </ul>
                      </div>
                    </div>
                  </div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-6">
                  ...
                  <div className="space-y-2">
                    {[
                      { 
                        ...
                        values: extractComponentData.types.length > 0 ? extractComponentData.types : null,
                      ...
                      { 
                        ...
                        values: extractComponentData.indexes.length > 0 ? extractComponentData.indexes : null
                      },
                      { 
                        name: "dataPath", 
                        required: false, 
                        ...
                        values: extractComponentData.dataPaths.length > 0 ? extractComponentData.dataPaths : null
                      },
                      { 
                        name: "config", 
                        required: false, 
                      ...
                      { 
                        ...
                        values: extractComponentData.titles.length > 0 ? extractComponentData.titles.slice(0, 10) : null,
                      ...
                      { 
                        ...
                        values: extractComponentData.texts.length > 0 ? extractComponentData.texts : null
                      },
                      { 
                        ...
                        values: extractComponentData.cardStyleVariants.length > 0 ? extractComponentData.cardStyleVariants : null
                      },
                      { 
                        ...
                        values: extractComponentData.cardContentVariantsList.length > 0 ? extractComponentData.cardContentVariantsList : null
                      },
                      { 
                      ...
                      { 
                        ...
                        values: extractComponentData.useDescription.length > 0 ? extractComponentData.useDescription : [false]
                      },
                      { 
                        name: "components", 
                        required: false, 
                      ...
                      <div key={field.name} className="flex items-start gap-3 p-3 bg-muted/30 rounded-lg">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-sm text-muted-foreground mb-2">{field.desc}</p>
                          
                          {/* Valores encontrados no JSON */}
                          {field.values && field.values.length > 0 && (
                            <div className="mt-2 p-2 bg-background rounded border">
                              <p className="text-xs font-semibold mb-1 text-muted-foreground">Valores encontrados no JSON:</p>
                              {field.valuesByCategory ? (
                                <div className="space-y-2">
                                  {Object.entries(field.valuesByCategory).map(([category, types]) => (
                                    types.length > 0 && (
                                      <div key={category}>
                                ...
                                <div className="flex flex-wrap gap-1">
                                  {field.values.map((val, idx) => (
                                    typeof val === 'string' && val.length > 50 ? (
                                      <div key={idx} className="text-xs text-muted-foreground truncate max-w-[200px]" title={val}>
                                        "{val.substring(0, 50)}..."
                                      </div>
                                    ) : typeof val === 'string' && val === '' ? (
                                      <Badge key={idx} variant="outline" className="text-xs">(string vazia)</Badge>
                                    ) : typeof val === 'string' ? (
                                      <Badge key={idx} variant="outline" className="text-xs">"{val}"</Badge>
                                    ) : (
                                      <Badge key={idx} variant="outline" className="text-xs">{String(val)}</Badge>
                                    )
                                  ))}
                                  {field.hasMore && (
                                    <Badge variant="outline" className="text-xs">... e mais {extractComponentData.titles.length - 10}</Badge>
                                  )}
                                </div>
                              )}
                            </div>
                          ...
                          {field.configValues && (
                            <div className="mt-2 p-2 bg-background rounded border">
                              <p className="text-xs font-semibold mb-1 text-muted-foreground">Campos de config encontrados:</p>
                              <div className="space-y-1">
                                {field.configValues.yAxisDataKeys.length > 0 && (
                                  <div>
                                    <span className="text-xs font-medium">yAxisDataKey: </span>
                                    <div className="flex flex-wrap gap-1 mt-1">
                                      {field.configValues.yAxisDataKeys.map(key => (
                                ...
                                {field.configValues.dataKeys.length > 0 && (
                                  <div>
                                    <span className="text-xs font-medium">dataKey: </span>
                                    <div className="flex flex-wrap gap-1 mt-1">
                                      {field.configValues.dataKeys.map(key => (
                                        <Badge key={key} variant="outline" className="text-xs">{key}</Badge>
                                      ))}
                                    </div>
                                  </div>
                                ...
                                {field.configValues.hasEmptyConfig && (
                                  <Badge variant="outline" className="text-xs">config: {"{}"} (objeto vazio)</Badge>
                                )}
                              </div>
                            </div>
                          )}
                  ...
                  <div className="space-y-2">
                    {[
                      { 
                        ...
                        values: extractSectionData.ids.length > 0 ? extractSectionData.ids : null
                      },
                      { 
                        name: "index", 
                        required: false, 
                        ...
                        values: extractSectionData.indexes.length > 0 ? extractSectionData.indexes : null
                      },
                      { 
                        name: "name", 
                        required: false, 
                        ...
                        values: extractSectionData.names.length > 0 ? extractSectionData.names : null
                      },
                      { 
                        name: "icon", 
                        required: false, 
                        ...
                        values: extractSectionData.icons.length > 0 ? extractSectionData.icons : null
                      },
                      { 
                        name: "subsections", 
                        required: false, 
                              ...
                              <div className="flex flex-wrap gap-1">
                                {field.values.map((val, idx) => (
                                  typeof val === 'string' && val.length > 30 ? (
                                    <div key={idx} className="text-xs text-muted-foreground" title={val}>
                                      "{val.substring(0, 30)}..."
                                    </div>
                                  ) : typeof val === 'string' ? (
                                    <Badge key={idx} variant="outline" className="text-xs">"{val}"</Badge>
                ...
                {/* Campos de Subseção */}
                <div className="space-y-3">
                  <h3 className="font-semibold text-lg">Campos de Subseção</h3>
                  <div className="space-y-2">
                    {[
                      { 
                        name: "id", 
                        ...
                        values: extractSubsectionData.ids.length > 0 ? extractSubsectionData.ids : null
                      },
                      { 
                        name: "index", 
                        required: false, 
                        type: "number", 
                        desc: "Ordem de exibição",
                        values: extractSubsectionData.indexes.length > 0 ? extractSubsectionData.indexes : null
                      },
                      { 
                        name: "name", 
                        required: false, 
                        ...
                        values: extractSubsectionData.names.length > 0 ? extractSubsectionData.names : null
                      },
                      { 
                        name: "icon", 
                        required: false, 
                        type: "string", 
                        desc: "Nome do ícone (lucide-react)",
                        values: extractSubsectionData.icons.length > 0 ? extractSubsectionData.icons : null
                      },
                      { 
                        name: "components", 
                        required: false, 
        ...
        <TabsContent value="datapath" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Exemplos práticos de JSON necessários para renderizar cada tipo de componente, incluindo os dados necessários
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-8">
                ...
                <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="border rounded-lg p-4 bg-background min-h-[200px]">
                          {renderComponentExampleWithData("barChart", {
                            type: "barChart",
                            index: 0,
                            dataPath: "sectionData.barChart",
                            config: {
                  ...
                  {/* SentimentStackedChart */}
                  <div className="space-y-3">
                    <h4 className="font-semibold text-lg">sentimentStackedChart</h4>
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        <p className="text-sm font-medium">JSON necessário:</p>
                        <div className="bg-muted/50 rounded-lg p-3">
                          <pre className="text-xs overflow-x-auto">
                            <code>{JSON.stringify({
                              ...
                              data: {
                                sectionData: {
                                  sentimentStackedChart: [
                                    { category: "Trabalho em Equipe", positive: 72.3, neutral: 18.5, negative: 9.2 },
                                    { category: "Desenvolvimento", positive: 68.1, neutral: 22.4, negative: 9.5 },
                                    { category: "Flexibilidade", positive: 65.2, neutral: 25.8, negative: 9.0 }
                                  ]
                                }
                              }
                            }, null, 2)}</code>
                      ...
                      <div className="space-y-2">
                        <p className="text-sm font-medium">Renderizado:</p>
                        <div className="border rounded-lg p-4 bg-background min-h-[200px]">
                          {renderComponentExampleWithData("sentimentStackedChart", {
                            type: "sentimentStackedChart",
                            index: 0,
                            dataPath: "sectionData.sentimentStackedChart",
                            config: {
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                      ...
                      <div className="space-y-2">
                        <p className="text-sm font-medium">Renderizado:</p>
                        <div className="border rounded-lg p-4 bg-background min-h-[200px]">
                          {renderComponentExampleWithData("npsStackedChart", {
                            type: "npsStackedChart",
                            index: 0,
                            dataPath: "question.data.npsStackedChart",
                            config: {}
                ...
                <div className="space-y-4">
                  ...
                  {/* Card com Borda */}
                  <div className="space-y-3">
                    <h4 className="font-semibold text-lg">card (border-left)</h4>
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        <p className="text-sm font-medium">JSON necessário:</p>
                        <div className="bg-muted/50 rounded-lg p-3">
                  ...
                  <div className="space-y-3">
                    <h4 className="font-semibold text-lg">card (com componentes aninhados)</h4>
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        <p className="text-sm font-medium">JSON necessário:</p>
                        <div className="bg-muted/50 rounded-lg p-3">
                      ...
                      <div className="space-y-2">
                        <p className="text-sm font-medium">Renderizado:</p>
                        <div className="border rounded-lg p-4 bg-background">
                          {renderComponentExampleWithData("card", {
                            type: "card",
                            index: 0,
                            title: "Análise de Sentimento",
                            text: "A análise de sentimento foi realizada com base nas respostas dos funcionários.",
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                      ...
                      <div className="space-y-2">
                        <p className="text-sm font-medium">Renderizado:</p>
                        <div className="border rounded-lg p-4 bg-background">
                          {renderComponentExampleWithData("npsScoreCard", {
                            type: "npsScoreCard",
                            index: 0,
                            dataPath: "question.data",
                            config: {}
                ...
                <div className="space-y-4">
                  ...
                  {/* DistributionTable */}
                  <div className="space-y-3">
                    <h4 className="font-semibold text-lg">distributionTable</h4>
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        <p className="text-sm font-medium">JSON necessário:</p>
                        <div className="bg-muted/50 rounded-lg p-3">
                          <pre className="text-xs overflow-x-auto">
                            <code>{JSON.stringify({
                              ...
                              data: {
                                sectionData: {
                                  distributionTable: [
                                    { segment: "Menos de 1 ano", count: 170, percentage: 20 },
                                    { segment: "1-3 anos", count: 298, percentage: 35 },
                                    { segment: "3-5 anos", count: 213, percentage: 25 },
                                    { segment: "Mais de 5 anos", count: 169, percentage: 20 }
                                  ]
                                }
                              }
                            }, null, 2)}</code>
                      ...
                      <div className="space-y-2">
                        <p className="text-sm font-medium">Renderizado:</p>
                        <div className="border rounded-lg p-4 bg-background">
                          {renderComponentExampleWithData("distributionTable", {
                            type: "distributionTable",
                            index: 0,
                            dataPath: "sectionData.distributionTable",
                            config: {}
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                          ...
                          <pre className="text-xs overflow-x-auto">
                            <code>{JSON.stringify({
                              ...
                              data: {
                                sectionData: {
                                  sentimentTable: [
                                    { segment: "Mais de 5 anos", positive: 78.5, neutral: 15.5, negative: 6 },
                                    { segment: "3-5 anos", positive: 72, neutral: 20, negative: 8 },
                                    { segment: "1-3 anos", positive: 65.5, neutral: 25.5, negative: 9 },
                                    { segment: "Menos de 1 ano", positive: 58, neutral: 28, negative: 14 }
                                  ]
                                }
                              }
                            }, null, 2)}</code>
                      ...
                      <div className="space-y-2">
                        <p className="text-sm font-medium">Renderizado:</p>
                        <div className="border rounded-lg p-4 bg-background">
                          {renderComponentExampleWithData("sentimentTable", {
                            type: "sentimentTable",
                            index: 0,
                            dataPath: "sectionData.sentimentTable",
                            config: {}
                  ...
                  {/* RecommendationsTable */}
                  <div className="space-y-3">
                    <h4 className="font-semibold text-lg">recommendationsTable</h4>
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        <p className="text-sm font-medium">JSON necessário:</p>
                        <div className="bg-muted/50 rounded-lg p-3">
                                ...
                                sectionData: {
                                  recommendationsTable: {
                                    ...
                                    items: [
                                      {
                                        id: 1,
                                        recommendation: "Implementar Sistema de Comunicação Interna Mais Eficiente",
                                        severity: "high",
                                        stakeholders: ["Comunicação Corporativa", "TI", "RH"],
                                        tasks: [
                                          { task: "Avaliar ferramentas de comunicação", owner: "TI" },
                                          { task: "Definir estratégia de comunicação", owner: "Comunicação" }
                                        ]
                                      },
                                      {
                                        id: 2,
                                        recommendation: "Reduzir Processos Burocráticos",
                                        severity: "high",
                                        stakeholders: ["Operações", "Processos"],
                                        tasks: [
                                          { task: "Mapear processos atuais", owner: "Processos" },
                                          { task: "Priorizar processos", owner: "Liderança" }
                                        ]
                                      }
                                    ]
                                  }
                      ...
                      <div className="space-y-2">
                        <p className="text-sm font-medium">Renderizado:</p>
                        <div className="border rounded-lg p-4 bg-background">
                          {renderComponentExampleWithData("recommendationsTable", {
                            type: "recommendationsTable",
                            index: 0,
                            dataPath: "sectionData.recommendationsTable",
                            config: {}
                ...
                {/* QUESTÕES */}
                <div className="space-y-4">
                  <h3 className="font-semibold text-xl">Questões (Responses Section)</h3>
                  <div className="bg-blue-50 dark:bg-blue-950/20 rounded-lg p-4 border border-blue-200 dark:border-blue-800 mb-4">
                    <p className="text-sm text-blue-900 dark:text-blue-100">
                      <strong>Importante:</strong> As questões <strong>não possuem</strong> um campo <code>components</code> no JSON. 
                      Os componentes são <strong>gerados automaticamente</strong> baseados no <code>questionType</code> usando templates pré-definidos.
                      Cada tipo de questão sempre renderiza os mesmos componentes na mesma ordem.
                    </p>
                  </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <p className="text-sm text-muted-foreground mb-2">
                      Componentes gerados automaticamente: <code>npsScoreCard</code>, <code>npsStackedChart</code>
                    </p>
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        <p className="text-sm font-medium">JSON necessário:</p>
                          ...
                          <pre className="text-xs overflow-x-auto">
                            <code>{JSON.stringify({
                              question: {
                                ...
                                index: 1,
                                questionType: "nps",
                                question: "Em uma escala de 0 a 10, qual a probabilidade de você recomendar nossa empresa?",
                                summary: "O NPS organizacional é de 35 pontos, indicando uma base sólida de promotores.",
                                data: {
                                  npsScore: 35,
                                  npsCategory: "Bom",
                                  npsStackedChart: [
                  ...
                  <div className="space-y-3">
                    <h4 className="font-semibold text-lg">Questão Multiple Choice</h4>
                    <p className="text-sm text-muted-foreground mb-2">
                          ...
                          <pre className="text-xs overflow-x-auto">
                            <code>{JSON.stringify({
                              question: {
                                ...
                                question: "Como você avalia o equilíbrio entre vida pessoal e profissional?",
                                summary: "A maioria dos funcionários (52%) avalia o equilíbrio como bom ou muito bom.",
                                data: {
                                  barChart: [
                                    { option: "Muito bom", value: 221, percentage: 26 },
                                    { option: "Bom", value: 221, percentage: 26 },
                  ...
                  {/* Questão Open-Ended */}
                  <div className="space-y-3">
                    <h4 className="font-semibold text-lg">Questão Open-Ended</h4>
                    <p className="text-sm text-muted-foreground mb-2">
                      Componentes gerados automaticamente: <code>sentimentStackedChart</code>, <code>topCategoriesCards</code>, <code>wordCloud</code>
                    </p>
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        <p className="text-sm font-medium">JSON necessário:</p>
                          ...
                          <pre className="text-xs overflow-x-auto">
                            <code>{JSON.stringify({
                              question: {
                                ...
                                question: "O que você mais valoriza na empresa?",
                                summary: "As respostas abertas destacam trabalho em equipe, oportunidades de desenvolvimento e flexibilidade como os principais valores.",
                                data: {
                                  sentimentStackedChart: [
                                    { category: "Trabalho em Equipe", positive: 72.3, neutral: 18.5, negative: 9.2 },
                                    { category: "Desenvolvimento Profissional", positive: 68.1, neutral: 22.4, negative: 9.5 },
                                    { category: "Flexibilidade", positive: 65.2, neutral: 25.8, negative: 9.0 }
                                  ],
                                  topCategoriesCards: [
                                    {
                                      ...
                                      percentage: 100,
                                      topics: [
                                        { topic: "colaboração eficiente", sentiment: "positive" },
                                        { topic: "ambiente colaborativo", sentiment: "positive" },
                                        { topic: "suporte entre colegas", sentiment: "positive" }
                                      ]
                                    },
                                    {
                                      rank: 2,
                                      ...
                                      percentage: 73,
                                      topics: [
                                        { topic: "oportunidades de crescimento", sentiment: "positive" },
                                        { topic: "treinamentos relevantes", sentiment: "positive" },
                                        { topic: "mentoria", sentiment: "positive" }
                                      ]
                                    },
                                    {
                                      rank: 3,
                                      ...
                                      percentage: 67,
                                      topics: [
                                        { topic: "horário flexível", sentiment: "positive" },
                                        { topic: "trabalho remoto", sentiment: "positive" },
                                        { topic: "autonomia", sentiment: "positive" }
                                      ]
                                    }
                                  ],
                                  wordCloud: [
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="border rounded-lg p-4 bg-background space-y-4">
                          ...
                          {renderComponentExampleWithData("topCategoriesCards", {
                          ...
                          {renderComponentExampleWithData("wordCloud", {
                            type: "wordCloud",
                            index: 2,
